...
app.post('/contact', upload.single('attachment'), async (req, res) => {
    try {
        ...
        const mailAdmin = {
            ...
            ...(req.file ? { attachments: [{ filename: req.file.originalname, content: req.file.buffer, contentType: req.file.mimetype }] } : {})
        };
        const mailUser = {
